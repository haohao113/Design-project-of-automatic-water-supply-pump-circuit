...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	...
	.DEF _mode1=R4
	.DEF _pump_status=R7
	.DEF _min_water_level=R8
	.DEF _min_water_level_msb=R9
	.DEF _max_water_level=R10
	.DEF _max_water_level_msb=R11
	.DEF _water_level=R12
	.DEF _water_level_msb=R13
	.DEF __lcd_x=R6
...
_0x0:
	.DB  0x4D,0x6F,0x64,0x65,0x3A,0x20,0x41,0x55
	.DB  0x54,0x4F,0x0,0x4D,0x6F,0x64,0x65,0x3A
	.DB  0x20,0x4D,0x41,0x4E,0x55,0x41,0x4C,0x0
	.DB  0x4D,0x69,0x6E,0x3A,0x20,0x0,0x25,0x64
	.DB  0x0,0x4D,0x61,0x78,0x3A,0x20,0x0,0x44
	.DB  0x69,0x73,0x74,0x61,0x6E,0x63,0x65,0x3A
	.DB  0x20,0x0,0x25,0x64,0x20,0x63,0x6D,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 00B3             water_level = measure_water_level();
	RCALL _measure_water_level
	MOVW R12,R30
; 0000 00B4             display_distance(water_level);
	MOVW R26,R12
	RCALL _display_distance
; 0000 00B5             display_min_max();
	RCALL _display_min_max
